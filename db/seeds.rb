...
User.create({first_name:"rob", last_name:"chen", username:"heyitsrob", email:"rob@ert.com",password:"passme",city:"new york", school:"flatiron",work:"coding",friends:[], lvl:1, exp:0, energy:5, max_energy:5, speed:1, profile_img: "https://cdn.pixabay.com/photo/2017/06/13/12/54/profile-2398783_960_720.png",cover_img: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Friends_logo.svg/2000px-Friends_logo.svg.png"})
User.create({first_name:"brian", last_name:"horrowitz", username:"imahufflepuff", email:"huffle@puff.com",password:"isawabird",city:"new york", school:"hogwarts",work:"coding", friends:[], lvl:1, exp:0, energy:5, max_energy:5, speed:1, profile_img: "https://cdn.pixabay.com/photo/2017/06/13/12/54/profile-2398783_960_720.png",cover_img: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Friends_logo.svg/2000px-Friends_logo.svg.png"})
User.create({first_name:"raquel", last_name:"randall", username:"dark raquel", email:"dark@raquel.com",password:"muchglares",city:"new york", school:"flatiron",work:"coding",friends:[], lvl:1, exp:0, energy:5, max_energy:5, speed:1, profile_img: "https://cdn.pixabay.com/photo/2017/06/13/12/54/profile-2398783_960_720.png",cover_img: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Friends_logo.svg/2000px-Friends_logo.svg.png"})
User.create({first_name:"amir", last_name:"safoev", username:"voldamir", email:"amir@slytherin.com",password:"slytherin",city:"new york", school:"hogwarts",work:"maybe coding",friends:[], lvl:1, exp:0, energy:5, max_energy:5, speed:1, profile_img: "https://cdn.pixabay.com/photo/2017/06/13/12/54/profile-2398783_960_720.png",cover_img: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Friends_logo.svg/2000px-Friends_logo.svg.png"})
