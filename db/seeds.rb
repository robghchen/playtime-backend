...
Event.create({title: "Captain Marvel @ AMC", price: 5.95, date: DateTime.parse("03/12/2019 6:00"), location: "AMC Empire 25", description: "We'll be meeting at the theatre in the lobby 10 minutes prior to showtime. Message Rob if you have trouble locating the theatre or group. Enjoy the movie! Seats must be reserved in advance and this movie is super hype, so please let me know if you are attending at least 3 days prior to showtime! Otherwise, you might get stuck with a front row seat in the corner alone YIKES!", banner_img: "https://secure.meetupstatic.com/photos/event/9/b/f/f/highres_479139935.jpeg", user_id: 1, event_img:"https://secure.meetupstatic.com/photos/event/5/8/9/e/highres_479122686.jpeg", enable_posts: false, enable_seats:true})
...
Seat.create({event_id: 1, user_id: 1, username: "heyitsrob" position: "J1"})
Seat.create({event_id: 1, position: "J2"})
Seat.create({event_id: 1, position: "J3"})
Seat.create({event_id: 1, position: "J4"})
